...
public class ComplexSlicer {
	...
	static public Slice2D Slice(Polygon2D polygon, List<Vector2f> slice)
	{
	...
	static private Slice2D SingleSlice(Polygon2D polygon, List<Vector2f> slice)
	{
		Slice2D result = Slice2D.Create (slice);
	...
	static private Slice2D SliceWithOneHole(Polygon2D polygon, List<Vector2f> slice, List<Vector2f> collisionSlice) {
		Slice2D result = Slice2D.Create (slice);
	...
	static private Slice2D SliceWithTwoHoles(Polygon2D polygon, List<Vector2f> slice, List<Vector2f> collisionSlice) {
		Slice2D result = Slice2D.Create (slice);
	...
	static private Slice2D SliceWithoutHoles(Polygon2D polygon, List<Vector2f> slice, List<Vector2f> collisionSlice) {
		Slice2D result = Slice2D.Create (slice);
	...
	static private Slice2D SlicePolygonInside(Polygon2D polygon, List<Vector2f> slice) // Create Polygon Inside?
	{
		Slice2D result = Slice2D.Create (slice);
